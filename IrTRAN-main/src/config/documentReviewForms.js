    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "id_message_type", label: "Вид сообщения (id)", type: "number" },
          { key: "id_sign_sending", label: "Признак отправки (id)", type: "number" },
          { key: "id_country_departure", label: "Страна отправления (id)", type: "number" },
          { key: "id_station_departure", label: "Станция отправления (id)", type: "number" },
          { key: "id_shipper", label: "Грузоотправитель (id)", type: "number" },
          { key: "id_carriage_ownership", label: "Принадлежность вагонов/контейнеров (id)", type: "number" },
          { key: "id_cargo_group", label: "Группа груза (id)", type: "number" },
          { key: "id_method_submission", label: "Способ подачи (id)", type: "number" },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "id_send_type", label: "Вид отправки (id)", type: "number" },
          { key: "id_shipper", label: "Грузоотправитель (id)", type: "number" },
          { key: "id_station_departure", label: "Станция отправления (id)", type: "number" },
          { key: "id_station_destination", label: "Станция назначения (id)", type: "number" },
          { key: "id_country_departure", label: "Страна отправления (id)", type: "number" },
          { key: "id_country_destination", label: "Страна назначения (id)", type: "number" },
          { key: "id_receiver", label: "Грузополучатель (id)", type: "number" },
          { key: "signed", label: "Подписан", type: "boolean" },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "id_station", label: "Станция составления (id)", type: "number" },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "id_station", label: "Станция (id)", type: "number" },
          { key: "signed", label: "Подписан", type: "boolean" },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "id_station", label: "Станция (id)", type: "number" },
          { key: "id_owner", label: "Владелец пути (id)", type: "number" },
    ...
    sections: [
      {
        ...
        fields: [
          { key: "id_station", label: "Станция (id)", type: "number" },
          { key: "id_contract", label: "Договор (id)", type: "number" },
          { key: "id_owner", label: "Владелец пути (id)", type: "number" },
          { key: "id_payer", label: "Плательщик (id)", type: "number" },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "id_carrier_org", label: "Перевозчик (id)", type: "number" },
          { key: "id_payer", label: "Плательщик (id)", type: "number" },
          { key: "period_from", label: "Период с", type: "date" },
          { key: "period_to", label: "Период по", type: "date" },
